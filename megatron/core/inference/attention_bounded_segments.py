...
read to decide whether to take the skip-AG MoE path.

The skip-AG MoE path skips the AllGather before each MoE layer and replaces
...
class SegmentRuntime:
    ...
    Attributes:
        ...
        moe_combine_destination_policy: Either ``"original_owner"`` (baseline)
            or ``"current_segment_owner"`` (skip-AG MoE AR return).
    """
